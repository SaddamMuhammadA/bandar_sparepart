...
class Etalase extends BaseController
{
    ...
    private $apiKey = "dd0e0271d24d574502c9b3e3e330fc17";
	...
	{
		$barang = new \App\Models\BarangModel();  //mengambil data barang dari Barang Model
		$model = $barang->findAll();               //ambil semua data barang
		return view('etalase/index',[
			'model' => $model,                      //passing data
		]);
    }
